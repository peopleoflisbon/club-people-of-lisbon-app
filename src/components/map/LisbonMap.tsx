      ...
      <div className="absolute right-4 z-10 flex flex-col items-end gap-2" style={{ top: safeTop }}>
        {isMapUser && (
          <a href="https://www.peopleoflisbon.com" target="_blank" rel="noopener noreferrer"
            style={{ display:'flex', alignItems:'center', gap:6, padding:'8px 14px', background:'#2F6DA5', color:'white', borderRadius:999, fontSize:12, fontWeight:700, textDecoration:'none', boxShadow:'0 2px 12px rgba(47,109,165,0.45)' }}>
            Join the Club ↗
          </a>
        )}
        {pins.length > 0 && (
