      ...
      <div className="absolute left-4 z-10" style={{ top: safeTop, pointerEvents: 'none' }}>
        {isMapUser ? (
          <button
            ...
            <span style={{ fontSize: 13, fontWeight: 700, color: '#C8102E', fontFamily: "'SF UI Display', -apple-system, BlinkMacSystemFont, sans-serif" }}>Exit Map</span>
          </button>
        ) : null}
      </div>
      {/* ── Top-right: Filter + Count + Search tucked into corner ── */}
      <div className="absolute right-3 z-10" style={{ top: safeTop, pointerEvents: 'none', display: 'flex', flexDirection: 'column', alignItems: 'flex-end', gap: 6 }}>
        {categories.length > 0 && (
