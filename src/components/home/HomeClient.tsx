  ...
  return (
    ...
    <div className="max-w-4xl mx-auto">
      ...
      <div className="px-4 lg:px-8 py-5 space-y-6">
        ...
        {/* 8. LEADERBOARD */}
        <Link href="/leaderboard" className="block relative overflow-hidden" style={{ backgroundImage: 'url(/sidebar-bg.png)', backgroundSize: 'cover', backgroundPosition: 'center' }}>
        ...
        {/* 9. MEMBERSHIP CARD */}
        <Link href="/membership-card" className="block relative overflow-hidden" style={{ backgroundImage: 'url(/sidebar-bg.png)', backgroundSize: 'cover', backgroundPosition: 'center top' }}>
