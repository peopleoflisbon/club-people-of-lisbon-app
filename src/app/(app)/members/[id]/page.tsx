              ...
              <div className="flex gap-2">
                {isOwnProfile ? (
                  <>
                    ...
                    <Link href={`/messages?with=${params.id}`} className="inline-flex items-center gap-2 px-4 py-2 text-white text-xs font-semibold transition-colors" style={{ background: "#2F6DA5" }} data- transition-colors">
                      Message
                    </Link>
                  </>
                ) : (
              ...
              <div className="flex flex-wrap gap-3">
                {profile.linkedin_url && (
                  <a href={profile.linkedin_url} target="_blank" rel="noopener noreferrer"
                    className="inline-flex items-center gap-1.5 text-xs text-stone-500 transition-colors font-medium px-3 py-2 rounded-xl" style={{ background: "#EEF4FA", color: "#2F6DA5" }} data-">
