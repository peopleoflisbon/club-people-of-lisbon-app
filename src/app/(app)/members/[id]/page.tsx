              ...
              <div className="flex gap-2">
                {isOwnProfile ? (
                  <>
                    ...
                    <Link href={`/messages?with=${params.id}`} className="inline-flex items-center gap-2 px-4 py-2 bg-brand text-white text-xs font-semibold hover:bg-brand/90 transition-colors">
                      Message
                    </Link>
                  </>
                ) : (
