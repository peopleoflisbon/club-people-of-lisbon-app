  ...
  return (
    <div className="flex-1 flex flex-col min-h-0">
      <div className="px-4 py-3 bg-white border-b border-stone-100 flex-shrink-0">
        <p className="text-sm font-semibold" style={{ color: "#1C1C1C" }}>Have fun exploring the locations we filmed each People Of Lisbon episode at, and catch up on our videos.</p>
      </div>
      <LisbonMap pins={pins || []} />
    </div>
  );
