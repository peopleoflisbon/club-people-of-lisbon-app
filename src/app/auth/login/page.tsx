  ...
  return (
    <div style={{
      ...
      <span style={{
        ...
        fontFamily: "'SF UI Display', -apple-system, BlinkMacSystemFont, 'Segoe UI', system-ui, sans-serif",
      }}>
        People Of Lisbon
      </span>
    </div>
...
export default function GatewayPage() {
  ...
  const ff = "'SF UI Display', -apple-system, BlinkMacSystemFont, 'Segoe UI', system-ui, sans-serif";
        ...
        <div className="splash-desktop" style={{
          ...
          {featuredPerson && (
            <div style={{ position: 'absolute', top: 40, right: 0, textAlign: 'right', background: 'linear-gradient(to left, rgba(0,0,0,0.5) 0%, rgba(0,0,0,0) 100%)', padding: '10px 24px 10px 48px' }}>
              <p style={{ fontSize: 14, fontWeight: 700, color: 'rgba(255,255,255,0.75)', margin: '0 0 3px', fontFamily: "'SF UI Display', -apple-system, BlinkMacSystemFont, 'Segoe UI', system-ui, sans-serif", letterSpacing: '0.02em' }}>Featured</p>
              <p style={{ fontSize: 14, fontWeight: 700, color: 'white', margin: 0, maxWidth: 220, lineHeight: 1.3, textAlign: 'right', fontFamily: "'SF UI Display', -apple-system, BlinkMacSystemFont, 'Segoe UI', system-ui, sans-serif" }}>{featuredPerson}</p>
            </div>
          )}
          ...
          <div style={{ maxWidth: 680, paddingTop: 0 }}>
            ...
            <h1 style={{ margin: '0 0 40px', lineHeight: 0.92, letterSpacing: '-0.04em', fontFamily: "'SF UI Display', -apple-system, BlinkMacSystemFont, 'Segoe UI', system-ui, sans-serif" }}>
          ...
          <div style={{ width: '100%', maxWidth: 560, padding: '0 32px calc(env(safe-area-inset-bottom) + 48px)' }}>
            ...
            {featuredPerson && (
              <div style={{ position: 'absolute', top: 'max(env(safe-area-inset-top), 24px)', right: 0, textAlign: 'right', background: 'linear-gradient(to left, rgba(0,0,0,0.55) 0%, rgba(0,0,0,0) 100%)', padding: '8px 16px 8px 32px' }}>
                <p style={{ fontSize: 13, fontWeight: 700, letterSpacing: '0.04em', color: 'rgba(255,255,255,0.7)', margin: '0 0 2px', fontFamily: "'SF UI Display', -apple-system, BlinkMacSystemFont, 'Segoe UI', system-ui, sans-serif" }}>Featured</p>
                <p style={{ fontSize: 13, fontWeight: 700, color: 'white', margin: 0, maxWidth: 180, lineHeight: 1.3, textAlign: 'right', fontFamily: "'SF UI Display', -apple-system, BlinkMacSystemFont, 'Segoe UI', system-ui, sans-serif" }}>{featuredPerson}</p>
              </div>
            )}
